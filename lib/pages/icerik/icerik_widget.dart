...
class IcerikWidget extends StatefulWidget {
  const IcerikWidget({
    super.key,
    required this.urun,
  });

  final UrunlerRecord? urun;

  @override
  State<IcerikWidget> createState() => _IcerikWidgetState();
}

class _IcerikWidgetState extends State<IcerikWidget>
    with TickerProviderStateMixin {
  late IcerikModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IcerikModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UrunlerRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final icerikUrunlerRecord = snapshot.data!;
